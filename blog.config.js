...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '5d67c10fc11a4e969803ccd0f3d3c81f',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lyq', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '正在抓紧搞学习✈', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'areslian323@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'areslian', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'areslian', // 管理员用户名、一般是自己 e.g 'tangly1024'
